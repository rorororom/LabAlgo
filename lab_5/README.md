...
В качестве второй функции была взята $$g(x) = (2 \cdot key + 1) \ mod \ size$$
...
|           Хэш-таблица (c -O3)            | Время, затраченное на 1млн запросов поиска (с) |
|:----------------------------------------:|:----------------------------------------------:|
| Хэш-таблица с методом цепочек            |                0.445352                        |
| Хэш-таблица с квадратичным хэшированием  |                0.336744                        |
| Хэш-таблица с идеальным хэшированием     |                0.296921                        |
...
Ура, при O3 идеальное хеширование снова быстрее всех
